...
private: // Секретна зона: сюди зась стороннім!
    ...
    // Метод "Внутрішній перфекціоніст" - приводить дріб до ладу !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    void reduce() {
...
public: // Публічна зона: кнопки та екранчики для користування
    ...
    // "Фабрика дробів" (Конструктор) - створює новий дріб. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    // "Перекладач на людську мову" (текст)   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    // "Перекладач на комп'ютерну мову" (число з комою) !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    double toDouble() const {
        return static_cast<double>(numerator) / denominator;
    }

    // "Сирий вигляд" - просто "число/число" !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    // Створюють НОВИЙ дріб-результат! !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!МИНУЛІ ЗАДАЧІ!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
